 ...
 */
package com.orangelabs.cloud4netportal.config;
...
public class DatastoreConfig {
    ...
    public static final String NCS_DIRECTORY = "data/ncsconfig";
     ...
     */
    @Bean
    public File datastoreBaseDirectory(final @Value("${cloud4netportal.datastore-base-directory:${user.dir}/var/dev}") String datastoreBaseDirectoryPath) {
    ...
    new File(rv, NCS_DIRECTORY).mkdirs();
	return rv;
    }
}
